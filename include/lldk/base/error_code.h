 ...
 */
LLDK_EXTERN_C void lldkSetErrorCode(lldk::common::ErrorCode eErrorCode);

/**
 * @brief Get the error code in the current thread
 * @return The error code
 */
LLDK_EXTERN_C lldk::common::ErrorCode lldkGetErrorCode();
 ...
 */
LLDK_EXTERN_C const char *lldkGetErrorStr(lldk::common::ErrorCode eErrorCode);
